...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 g-5">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary me-2" href="http://localhost/tp1Dinamica/view/index.php">Tp1</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary me-2 active " href="http://localhost/tp2Dinamica/view/index.php">Tp2</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary me-2" href="http://localhost/tp3Dinamica/view/index.php">Tp3</a>
                    </li>
                </ul>
    ...
    <div class="container bg-secondary p-3 needs-validation" novalidate style="width : 400px">
        <form action="ejercicio3Vista.php" method="post" id="prueba3" onsubmit="return verificacion3()"
            ...
            <div class="mb-3 w-100 input-group">
                ...
                <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Username" name="usuario"
    ...
    <div class="container w-75 d-flex">
        ...
        <form action="ejercicio4.php" method="get" class="d-flex flex-wrap gap-3 needs-validation"
            novalidate style="font-family: Arial, sans-serif">
            ...
            <div class="w-100 d-flex gap-5">
                ...
                <div class="w-100 d-flex flex flex-column">
                    <h5>Guion</h5>
                    <input type="text" name="guion" id="guion" placeholder="Guion" class=" form-control border border-secondary p-3"
            ...
            <div class="w-100 d-flex gap-5">
                <div class="w-100 d-flex flex-column">
                    <h5>Produccion</h5>
                    <input type="text" name="produccion" id="produccion" class="form-control border border-secondary p-3"
                        style="height: 40px" required>
                    <div class="valid-feedback"></div>
            ...
            <div class="w-100 d-flex gap-5">
                <div class="w-100 d-flex flex-column">
                    <h5>Nacionalidad</h5>
                    <input type="text" name="nacionalidad" id="nacionalidad" class="form-control border border-secondary p-3"
                        style="height: 40px" required>
                    <div class="valid-feedback"></div>
                ...
                <div class="w-100 d-flex flex flex-column">
                    <h5>Genero</h5>
                    <select name="genero" id="genero" style="width: 200px; height: 40px" class="form-control border border-secondary"
                        required>
                ...
                <div class="w-100 d-flex flex-column">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="restriccion" id="restriccion1" value="todos"
                            required>
                            <label class="form-check-label" for="restriccion1">Todos los públicos</label>
                        </div>
                        
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="restriccion" id="restriccion2" value="mayores a 7">
                            <label class="form-check-label" for="restriccion2">Mayores de 7 años</label>
                        </div>
                        
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="restriccion" id="restriccion3" value="mayores de 18">
            ...
            <div class="w-100">
                ...
                <h5>Sinopsis</h5>
                <textarea name="sinopsis" id="sinopsis" cols="1" class="w-100 border border-secondary" style="height: 100px"
                    required></textarea>
                <div class="valid-feedback"></div>
