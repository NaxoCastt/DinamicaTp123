...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 g-5">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary me-2  " href="http://localhost/tp2Dinamica/view/index.php">Tp2</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary me-2 active" href="http://localhost/tp3Dinamica/view/index.php">Tp3</a>
                    </li>
                </ul>
    ...
    <div class="container w-75 d-flex">
        ...
        <form action="Ejercicio3Vista.php" method="post" class="d-flex flex-wrap gap-3 needs-validation"
            novalidate style="font-family: Arial, sans-serif" enctype="multipart/form-data">
