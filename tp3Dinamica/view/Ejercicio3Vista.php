<?php
include_once '../controller/Ejercicio3.php';
$bandera = ejercicio3();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container d-flex flex-column mx-auto m-5 p-4"
        ...
        <?php   
            if($bandera){
                ...
                echo (" <img src='../view/". $_FILES['imagen']['name']. "' alt= 'Portada de la pelicula ". $_POST['titulo'] ."' class='img-fluid rounded shadow mt-3' style='max-width: 200px; height: auto'/> " );
            }
            else{
